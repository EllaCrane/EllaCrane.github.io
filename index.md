...
- **[Dec. 2024]** Completed the [Adaptive Leadership course at the Harvard Kennedy School](https://www.hks.harvard.edu/publications/practice-adaptive-leadership-tools-and-tactics-changing-your-organization-and-world).
- **[Nov. 2024]** Our preprint on [fermion-qubit error correction](https://arxiv.org/pdf/2411.08955) has appeared on the arXiv which shows an exponential advantage from O(N) to O(log N) for the quantum simulation of crystalline molecules or materials. As usual, it was great working with Alexander Schuckert, and Michael Gullans.
